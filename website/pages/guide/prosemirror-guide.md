...
Use `createListPlugins` to create other plugins. You can view its [reference](../docs/modules/prosemirror_flat_list.md#createlistplugins) to see what plugins it creates.
...
`prosemirror-flat-list` provides a variety of commands to manipulate the list node type. Please view the [reference](../docs/modules/prosemirror_flat_list.md#commands) to see what commands it provides.
